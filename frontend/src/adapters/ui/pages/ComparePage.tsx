    ...
    <div>
      ...
      <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white p-4 rounded shadow-sm">
          ...
          <p className="text-lg">{baseline?.routeId} — {baseline?.ghgIntensity} gCO₂e/MJ</p>
        </div>
      ...
      <div className="mt-4 bg-white p-3 rounded shadow-sm">
        <table className="w-full">
          <thead className="bg-slate-100"><tr><th>Route</th><th>GHG</th><th>% vs baseline</th><th>Compliant</th></tr></thead>
          <tbody>
